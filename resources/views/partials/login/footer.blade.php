...
.navbar{
    ...
    background-image: linear-gradient(220deg, #000000 0%, #2c3e50 74%);
}
</style>
<div class="navbar navbar-expand-lg navbar-dark">
    ...
    <div class="navbar-collapse collapse" id="navbar-footer">
					<span class="navbar-text">
						&copy; {{ date('Y') }}. <a href="https://kazakhsdevelopers.com">{{ Qs::getSystemName() }}</a> by <a href="https://instagram.com/nawrasbukhari" >Nawras Bukhari</a>
					</span>
